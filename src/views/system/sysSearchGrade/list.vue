<template>
    <div class="app-container">
        ...
        <div class="tools-div">
            ...
            <el-button class="btn-add" icon="el-icon-delete" type="danger" size="mini"
        ...
        <el-table v-loading="listLoading" :data="list" stripe border style="width: 100%; margin-top: 10px"
            ...
            <el-table-column prop="Name" label="学生ID" />
            <el-table-column prop="CourseName" label="姓名" />
            <el-table-column prop="thesis" label="班级" width="160" />
            <el-table-column prop="state" label="成绩" width="160" />
...
<script>
import api from "@/api/system/sysGrade";
export default {
    // 定义数据模型
    data() {
        return {
